    ...
    <form onSubmit={handleSubmit} className="mb-6">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-400 disabled:cursor-not-allowed transition-colors"
        >
          Add
        </button>
      </div>
